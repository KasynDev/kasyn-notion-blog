...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '31f9ba6f8d554d108bf605a0791d9482',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kasyn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'After all this time? Always.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kasyn.blog', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Web3, Blockchain, Golang', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'kasyner@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/kasyner', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/KasynDev', // 你的github个人主页 例如 https://github.com/tangly1024
